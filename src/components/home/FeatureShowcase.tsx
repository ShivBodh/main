...
export function FeatureShowcase() {
    const bubbleStyles = [
        ...
        { size: 'w-8 h-8', position: 'top-1/4 left-1/4', delay: '0s', color: 'bg-primary/10' },
        { size: 'w-12 h-12', position: 'top-1/2 right-1/4', delay: '2s', color: 'bg-accent/10' },
        { size: 'w-16 h-16', position: 'bottom-1/4 left-1/3', delay: '4s', color: 'bg-secondary/10' },
        { size: 'w-10 h-10', position: 'top-10 right-10', delay: '1s', color: 'bg-primary/10' },
        { size: 'w-20 h-20', position: 'bottom-10 left-10', delay: '3s', color: 'bg-accent/10' },
        { size: 'w-24 h-24', position: 'bottom-1/3 right-1/3', delay: '5s', color: 'bg-secondary/10' },
        { size: 'w-14 h-14', position: 'top-20 left-1/2', delay: '6s', color: 'bg-primary/10' },
        { size: 'w-10 h-10', position: 'bottom-20 right-1/2', delay: '7s', color: 'bg-accent/10' },
        { size: 'w-28 h-28', position: 'top-1/3 left-1/3', delay: '8s', color: 'bg-secondary/10' },
         { size: 'w-12 h-12', position: 'bottom-10 right-1/4', delay: '9s', color: 'bg-primary/10' },
    ];
