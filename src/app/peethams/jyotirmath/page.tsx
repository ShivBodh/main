...
import { ExternalLink, BookOpen, Calendar, Camera, MapPin, Mail, Briefcase, Globe, Mountain, ArrowRight, Video, Landmark } from 'lucide-react';
           ...
           <TabsContent value="seva">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                     <Image src="https://images.unsplash.com/photo-1564161763785-6448e4235825?q=80&w=1200&h=600&fit=crop" alt="Map of Jyotirmath Peetham" width={1200} height={600} className="rounded-lg object-cover w-full h-full aspect-video" data-ai-hint="himalayan landscape"/>
                </div>
            </div>
          </TabsContent>
        </Tabs>
