                                 ...
                                 <Card key={video.id}>
                                    ...
                                    <CardContent>
                                        ...
                                        <Dialog>
                                            <DialogTrigger asChild>
                                                <div className="block relative aspect-video rounded-lg overflow-hidden group bg-secondary cursor-pointer">
                                                    <Image src={`https://placehold.co/800x450.png`} alt={video.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="dwaraka facebook video" />
                                                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
