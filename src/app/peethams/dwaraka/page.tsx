                                    ...
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <div className="block relative aspect-video rounded-lg overflow-hidden group bg-secondary cursor-pointer">
                                                <Image src={'https://source.unsplash.com/800x450/?dwaraka,video'} alt={video.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="dwaraka video" />
                                 ...
                                 <Card key={video.id}>
                                    ...
                                    <CardContent>
                                        ...
                                        <Dialog>
                                            <DialogTrigger asChild>
                                                <div className="block relative aspect-video rounded-lg overflow-hidden group bg-secondary cursor-pointer">
                                                    <Image src={'https://source.unsplash.com/800x450/?dwaraka,facebook,video'} alt={video.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="dwaraka facebook video" />
                                                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
           ...
           <TabsContent value="seva">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                     <Image src="https://source.unsplash.com/1200x600/?city,map" alt="Map of Dwaraka Peetham" width={1200} height={600} className="rounded-lg object-cover w-full h-full aspect-video" data-ai-hint="city map" />
                </div>
            </div>
          </TabsContent>
        </Tabs>
