      ...
      <div className="container mx-auto max-w-6xl py-16 md:py-24 px-4">
        <section className="flex flex-col md:flex-row items-center gap-8 mb-12">
          <div className="w-full md:w-1/3">
            <Image
              src="https://images.unsplash.com/photo-1596701836244-a73e65935105?q=80&w=1964&auto=format&fit=crop"
                                    ...
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <div className="block relative aspect-video rounded-lg overflow-hidden group bg-secondary cursor-pointer">
                                                <Image src={'https://source.unsplash.com/800x450/?himalayan,video'} alt={video.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="himalayan video" />
                                ...
                                <Card key={video.id}>
                                    ...
                                    <CardContent>
                                        ...
                                        <Dialog>
                                            <DialogTrigger asChild>
                                                <div className="block relative aspect-video rounded-lg overflow-hidden group bg-secondary cursor-pointer">
                                                    <Image src={'https://source.unsplash.com/800x450/?jyotirmath,facebook,video'} alt={video.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="jyotirmath facebook video" />
                                                    <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
           ...
           <TabsContent value="seva">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                     <Image src="https://source.unsplash.com/1200x600/?himalayan,map" alt="Map of Jyotirmath Peetham" width={1200} height={600} className="rounded-lg object-cover w-full h-full aspect-video" data-ai-hint="himalayan map" />
                </div>
            </div>
          </TabsContent>
        </Tabs>
