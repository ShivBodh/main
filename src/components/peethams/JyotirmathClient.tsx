...
export default function JyotirmathClient() {
    ...
    const jyotirmathYoutube = useMemo(() => jyotirmathMedia.filter((item): item is CalendarYouTubeItem => item.type === 'youtube'), [jyotirmathMedia]);
    const jyotirmathFacebook = useMemo(() => jyotirmathMedia.filter((item): item is CalendarFacebookItem => item.type === 'facebook'), [jyotirmathMedia]);
