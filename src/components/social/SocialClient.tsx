...
const placeholderMitras: Mitra[] = [
    { name: 'Ravi Sharma', handle: '@rsharma', avatar: 'https://images.unsplash.com/photo-1593179448852-6a56e2e5055b?q=80&w=40&h=40&fit=crop&crop=faces' },
    { name: 'Priya Patel', handle: '@priya_p', avatar: 'https://images.unsplash.com/photo-1542823184-a828da22ca3e?q=80&w=40&h=40&fit=crop&crop=faces' },
];
...
const placeholderNotifications: Notification[] = [
    {
        id: 'notif-1',
        type: 'mitra_request',
        actor: { name: 'Arjun Das', avatar: 'https://images.unsplash.com/photo-1593179448852-6a56e2e5055b?q=80&w=40&h=40&fit=crop&crop=faces' },
    ...
    },
    {
        ...
        actor: { name: 'Sita Iyer', avatar: 'https://images.unsplash.com/photo-1542823184-a828da22ca3e?q=80&w=40&h=40&fit=crop&crop=faces' },
...
const suggestedMitras: Mitra[] = [
    { name: 'Sita Iyer', handle: '@sita_iyer', avatar: 'https://images.unsplash.com/photo-1542823184-a828da22ca3e?q=80&w=40&h=40&fit=crop&crop=faces' },
    { name: 'Krishna Rao', handle: '@k_rao', avatar: 'https://images.unsplash.com/photo-1593179448852-6a56e2e5055b?q=80&w=40&h=40&fit=crop&crop=faces' },
    { name: 'Gauri Desai', handle: '@gauridesai', avatar: 'https://images.unsplash.com/photo-1542823184-a828da22ca3e?q=80&w=40&h=40&fit=crop&crop=faces' },
];
