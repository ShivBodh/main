          ...
          <TabsContent value="events">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        The latest happenings connected to the Govardhana Peetham. For a full list of all events, visit the main Bodha Calendar.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    {puriEvents.length > 0 ? (
           ...
           <TabsContent value="seva">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                     <Image src="https://images.unsplash.com/photo-1594178384473-a5518357494a?q=80&w=1200&h=600&fit=crop" alt="Map of Puri Peetham" width={1200} height={600} className="rounded-lg object-cover w-full h-full aspect-video" data-ai-hint="puri beach" />
                </div>
            </div>
          </TabsContent>
        </Tabs>
