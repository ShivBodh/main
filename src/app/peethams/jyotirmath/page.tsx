      ...
      <div className="container mx-auto max-w-6xl py-16 md:py-24 px-4">
        <section className="flex flex-col md:flex-row items-center gap-8 mb-12">
          <div className="w-full md:w-1/3">
            <Image
              src="https://source.unsplash.com/random/800x600/?himalayan,monastery"
                                    ...
                                    <Dialog>
                                        <DialogTrigger asChild>
                                            <div className="block relative aspect-video rounded-lg overflow-hidden group bg-secondary cursor-pointer">
                                                <Image src={`https://placehold.co/800x450.png`} alt={video.title} fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="himalayan video" />
           ...
           <TabsContent value="seva">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2">
                     <Image src="https://source.unsplash.com/random/1200x600/?himalayan,map" alt="Map of Jyotirmath Peetham" width={1200} height={600} className="rounded-lg object-cover w-full h-full aspect-video" data-ai-hint="himalayan map" />
                </div>
            </div>
          </TabsContent>
        </Tabs>
